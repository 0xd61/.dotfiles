...
We want to remove the frame bar of gtk
#+begin_src emacs-lisp
...
#+end_src
** App launcher
As an alternative to exwm we use emacs still as app launcher
...
We make our own wrapper for the launcher to be able to run it anywhere. This is inspired by the approach of [[https://gitlab.com/dwt1/configuring-emacs/-/blob/main/07-the-final-touches/scripts/app-launchers.el?ref_type=heads][Derek Taylor]].
