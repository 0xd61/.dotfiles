...
let g:colors_name='dgl'
set background=dark

if !exists("g:dgl_terminal_italics")
  let g:dgl_terminal_italics = 0
endif

if !exists("g:dgl_terminalcolors")
